...
contract FullDeploymentTest is BaseFactoryTest {
  ...
  function test_SubDaosHaveDifferentVoteDurations() public {
    ...
    assertEq(approverDuration, 259_200, "Approver should have 3 day voting (259200 sec)");
    assertEq(memberDuration, 86_400, "Member-curator should have 1 day voting (86400 sec)");
    assertTrue(memberDuration < approverDuration, "Member-curator duration should be shorter than approver duration");
  }
}
