...
contract ConfigValidationTest is Test {
  ...
  function test_MemberCuratorConfigIsValid() public {
    ...
    assertTrue(memberCuratorConfig.stage2VoteDuration > 0, "Member-curator stage2 vote duration should be positive");
    assertTrue(memberCuratorConfig.stage2MinDuration > 0, "Member-curator stage2 min duration should be positive");
  }
